...
public record BedwarsConfig(int teamSize, BedwarsMapConfig mapConfig, ForgeConfig forgeConfig, int highLimit, int downLimit, Identifier shopConfigId) {
    public static final Codec<BedwarsConfig> CODEC = RecordCodecBuilder.create(instance ->
        instance.group(
                ...
                Identifier.CODEC.fieldOf("shop_config").forGetter(BedwarsConfig::shopConfigId)

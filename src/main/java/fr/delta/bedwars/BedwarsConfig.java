...
public record BedwarsConfig(int teamSize, Identifier mapId, Identifier forgeConfigId, List<Identifier> generatorTypeIdList, Identifier shopCategoriesId, Identifier shopEntriesId, int highLimit, int downLimit, int voidHigh, List<GameEvent> events) {

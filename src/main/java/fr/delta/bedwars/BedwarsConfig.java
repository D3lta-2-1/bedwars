...
public record BedwarsConfig(int teamSize, BedwarsMapConfig mapConfig, Forge.ForgeConfig forgeConfig, List<GeneratorBuilder> generatorTypeList, List<GameEvent> events, Identifier shopCategoriesId, Identifier shopEntriesId, int highLimit, int downLimit, int voidHigh) {
